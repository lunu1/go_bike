    ...
    <div className="py-36">
      ...
      >
        <div>
          ...
          <h1 className="text-xl">Go-bike</h1> 
          <p className="text-light-gray my-7 text-center lg:text-start">
          "Rent a bike, explore the unknown, and make your own path."
          </p>
        ...
        <ul className="flex flex-col sm:flex-row items-center gap-10 mx-auto lg:mx-0">
          ...
          <li className="link border-transparent">bikemodel</li>
          <li className="link border-transparent">Testimonial</li>
